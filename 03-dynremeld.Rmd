...
df_tab$Variable <- str_replace(df_tab$Variable, 'December', 'Dec')
...
if (knitr::is_html_output()) {
  ...
  df_tab |>
    kable(format='latex', caption=paste(CH3_TABLE_CAPTIONS[['TAB1_baseline']], FOOTNOTE_TEXT, sep=' '), booktabs=TRUE, align='llccc') |>
    kable_styling(
    ...
    read_lines() |>
    str_replace(
      fixed('autoimmune/cryptogenic'),
      '\\makecell[l]{autoimmune or\\\\cryptogenic}'
    ) |>
    paste0(collapse='\n') |>
    cat()
  }
...
<!-- while they can inform revision of MELD with a *"from cross-section"* approach. -->
...
if (knitr::is_html_output()) {
  d_tab |>
   ...
   d_tab |>
    kable(format='latex', booktabs=TRUE, align = 'ccccc') |>
